const ApiKey = "a890596570e54cd8a6ba5ff24db132aa";
...
function getListInformations(id) {
    ...
    .then(info=> {contents.innerHTML = ` 
        ...
        <div class="card blue-grey darken-1">
            <img class="circle" src="${info.crestUrl}">
            <h2><b>${info.name}</b></h2>
            <div class="card blue-grey darken-1">
                <div class="card-content white-text">
                <table class="stripped responsive-table">
                <tr>
                <td><b>Nama </b></td><td>${info.shortName}</td></tr>
                <tr>
                <td><b>Alamat </b></td><td>${info.address}<br></tr>
                <tr>
                <td><b>Nomor Telp </b></td><td>${info.phone}<br></tr>
                <tr>
